...
8. **Lite/Pro code split — DECIDED 2026-07-08**: hybrid, with one rule: *whoever owns the endpoint owns the UI code.*
   ...
   - **One registration surface, not nine ad-hoc filters**: pro extends through `hyve.routes` (screens/subs) plus at most one component-slot filter. That is the whole P1 contract.
