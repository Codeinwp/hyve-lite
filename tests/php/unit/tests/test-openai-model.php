...
class Test_OpenAI_Model extends WP_UnitTestCase {
	...
	public function test_gpt35_falls_back_to_default() {
		$this->assertEquals( 'gpt-5.4-nano', OpenAI::resolve_chat_model( 'gpt-3.5-turbo-0125' ) );
		$this->assertEquals( 'gpt-5.4-nano', OpenAI::resolve_chat_model( 'gpt-3.5-turbo' ) );
	}
	...
	public function test_empty_or_invalid_falls_back_to_default() {
		$this->assertEquals( 'gpt-5.4-nano', OpenAI::resolve_chat_model( '' ) );
		$this->assertEquals( 'gpt-5.4-nano', OpenAI::resolve_chat_model( null ) );
		$this->assertEquals( 'gpt-5.4-nano', OpenAI::resolve_chat_model( [] ) );
	}
	...
	public function test_supported_models_pass_through() {
		foreach ( [ 'gpt-5.6-sol', 'gpt-5.6-terra', 'gpt-5.6-luna', 'gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini', 'gpt-5.4-nano', 'gpt-5', 'gpt-4.1', 'gpt-4o-mini', 'gpt-4o' ] as $model ) {
