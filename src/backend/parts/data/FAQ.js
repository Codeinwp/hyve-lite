			...
			>
				<PanelRow>
					...
					<div className="relative pt-4 pb-8 overflow-x-auto">
						...
						<UpsellContainer
							title={ __( 'FAQ is a Premium feature', 'hyve-lite' ) }
							description={ __( 'Review unanswered questions, enhance your bot\'s knowledge base, and refine your users\' interactive experience. Upgrade now!', 'hyve-lite' ) }
							...
							<div className="flex flex-col">
								<div className="bg-gray-50 px-6 py-3 text-left text-xs text-gray-700 uppercase">
									<div className="flex">
										...
										<div className="w-1/6">{ __( 'Count', 'hyve-lite' ) }</div>
